  ...
  <div class="modal-dialog">
      <div class="modal-content" id="modal1">
        <div class="signup-form">
          <form method="POST" action="editcontrollerStudent.jsp">
            <% if(request.getAttribute("message4") != null) { %>		
              <div class="alert alert-danger" role="alert"><%=(String)request.getAttribute("message4") %></div>
            <% } %>
            ...
            <div class="form-group">
              <input type="number" class="form-control" name="entry_year" placeholder="Entry year">
            </div>
            <div class="form-group">
              <input type="number" class="form-control" name="semester" placeholder="Current semester">
            </div>
            <div class="form-group">
              <input type="text" class="form-control" name="subject" placeholder="Favorite subject">
            </div>
            <div class="form-group">
